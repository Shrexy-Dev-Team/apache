  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="https://discord.gg/4542zQn" class="w3-bar-item w3-button">Discord</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="https://discord.gg/4542zQn" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">DISCORD</a>
</div>
...
?>
 ...
 <h2>Player stats for <?php echo $playerid ?>:</h2>
...
<div id="playerInfo" class="tabcontent">
  ...
  <p>
    ...
    try{
      ...
      echo "<h3>Player UUID:    ", $database->sessions[0]->player_uuid, "</h3>";
      echo "<h3>Location:    ", $database->connections[0]->geolocation, "</h3>";
...
<div id="connection" class="tabcontent">
  ...
  <p>
    <?php
    try{
    echo "<h3>Avg. Ping:    ", $database->info->average_ping, "</h3>";
    echo "<h3>Best Ping:    ", $database->info->best_ping, "</h3>";
    echo "<h3>Worst Ping:    ", $database->info->worst_ping, "</h3>";
    }
  catch(Exception $e){
      echo "<h3> Player not found </h3>";
    }
